...
```
\vspace*{20pt}
Thank you for taking part in the \textbf{\color{Cerulean}MAGIC}\textbf{ / \color{RedOrange}IMAGINE} study! The participation of people like you is
essential to advancing our understanding of the microbiome and its role in
health and disease.
...
\begin{center}
\includegraphics{img/hearts.png}
\end{center}
...
```{r, child = 'ChildDocs/Disclaimer.Rmd'}
```
