...
related groups called "species". Those species can then be grouped together into
bigger groups called "genera" (singular: genus), and genera can be grouped
together into families, and so on up the tree of life. 

TAXONOMIC HIERARCHY IMAGE

Each bacterial species
has a unique genetic "barcode" that can be used to identify it. To determine the
composition of each sample's microbiome, we extract the DNA from your stool
sample and then isolate and sequence these bacterial DNA barcodes. We don't
sequence any human DNA, just the bacterial barcodes. We generate 10,000 to
50,000 barcode sequences per sample. Each sequence is then labeled with its
taxonomic identity (which species, genus, family, etc. it belongs to) and the
